		...
		<div class="border border-stone-200/60 bg-white/40 p-6">
			...
			<div class="grid gap-5 sm:grid-cols-2">
				<div class="sm:col-span-2">
					...
					<input id="title" type="text" class="admin-input" bind:value={title} />
				</div>

				<div>
					<label for="artist" class="admin-label">Artiste</label>
					<input id="artist" type="text" class="admin-input" bind:value={artist} list="artist-list" />
				...
				<div>
					...
					<input id="book" type="text" class="admin-input" bind:value={book} />
				</div>

				<div>
					<label for="bookFullName" class="admin-label">Livre (nom complet)</label>
					<input id="bookFullName" type="text" class="admin-input" bind:value={bookFullName} />
				</div>
