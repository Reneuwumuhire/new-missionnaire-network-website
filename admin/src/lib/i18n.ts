...
const COOKIE_NAME = 'mn_admin_locale';
const STORAGE_KEY = 'mn_admin_locale';
const COOKIE_MAX_AGE = 60 * 60 * 24 * 365; // 1 year

// SSR always renders French (the canonical language); the saved locale is
// applied after hydration via initLocale().
...
/**
 * Translation function store. Usage: `$t('common.save')` or with
 * placeholders: `$t('audio.showing', { from: 1, to: 20, total: 87 })`.
