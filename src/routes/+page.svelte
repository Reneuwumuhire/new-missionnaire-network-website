		...
		<section class="mb-8 rounded-2xl border border-gray-200 bg-white p-4 md:p-6 shadow-sm">
			<div class="grid gap-5 lg:grid-cols-[minmax(0,1fr)_320px] lg:items-start">
				<div>
					...
					<p class="mt-3 text-sm md:text-[15px] text-gray-700 max-w-3xl">
						Retrouvez rapidement les prédications, cantiques, transcriptions et publications
						pour fortifier votre communion et votre marche quotidienne.
					</p>

					<div class="mt-4 flex flex-wrap gap-2">
						<span
							class="inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-wider bg-orange-50 text-orange-600"
						>
							Prédications
						</span>
						<span
							class="inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-wider bg-blue-50 text-blue-600"
						>
							Musique
						</span>
						<span
							class="inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-wider bg-green-50 text-green-600"
						>
							Littérature
						</span>
					</div>
					...
					<div class="mt-5 flex flex-wrap gap-3">
						...
						>
							Aller aux nouveautés
						</a>
					</div>
				</div>

				<aside class="rounded-xl border border-gray-100 bg-gray-50/80 p-4">
					<p class="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500">Accès rapide</p>
					<div class="mt-3 grid grid-cols-2 gap-2">
						<a
							href="/musique"
							class="rounded-lg border border-gray-200 bg-white px-3 py-2 text-[11px] font-black uppercase tracking-wider text-gray-700 hover:border-orange-300 hover:text-orange-600 transition-colors text-center"
						>
							Musique
						</a>
						<a
