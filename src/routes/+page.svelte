...
<h4 class="text-center text-7xl pt-10 px-10 mb-10">{$t('welcome')}</h4>
<h1 class="text-center text-7xl pt-10 px-10 mb-10 text-gray-500">{$t("This is the implementation for")} {webName}</h1>
