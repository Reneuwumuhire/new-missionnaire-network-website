	...
	<div class="relative mb-8">
		<div class="flex flex-row items-center justify-center">
			<div class="w-full max-w-4xl text-center">
				...
				<p class="text-gray-600 mb-2">Trouvez les transcriptions des prédications</p>
				<p class="text-sm text-gray-500 mb-6">{data.pagination.total} transcription{data.pagination.total > 1 ? 's' : ''} disponible{data.pagination.total > 1 ? 's' : ''}</p>
