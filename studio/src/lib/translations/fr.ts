...
const fr: Record<keyof typeof en, string> = {
	...
	'preflight.title': 'Vérification avant diffusion',
	'preflight.intro':
		'Corrigez les blocages avant de démarrer le signal test. Les avertissements peuvent être ignorés.',
	'preflight.previewHint':
		'Après cette vérification, laissez le signal test tourner jusqu’à ce que les images/s, le débit et les destinations soient stables avant de rendre le service public.',
	'preflight.session': 'Session en direct',
	'preflight.destination': 'Sorties',
	'preflight.network': 'Réseau',
	'preflight.encoder': 'Encodeur',
	'preflight.canvas': 'Image du programme',
	'preflight.sources': 'Sources du programme',
	'preflight.audio': 'Signal audio',
	'preflight.rendering': 'Rendu',
	...
	'preflight.checking': 'Vérification…',
	'preflight.runAgain': 'Revérifier',
	'preflight.start': 'Démarrer le signal test',
	'preflight.startAnyway': 'Démarrer avec avertissements',
	'preflight.allReady': 'Toutes les vérifications sont prêtes.',
	'preflight.blockerCount': '{count} blocage(s) doivent être corrigés.',
	'preflight.warningCount': '{count} avertissement(s) à contrôler.',
	'preflight.encoderChecking': 'Vérification de l’encodeur FFmpeg installé…',
	'preflight.storageUnknown': 'L’espace disponible n’a pas pu être confirmé.',
	'preflight.storageAvailable': '{available} disponibles · {needed} recommandés pour deux heures',
	'preflight.audioMissing': 'Aucune source audio n’est configurée.',
	'preflight.audioMuted': 'Toutes les sources audio configurées sont coupées.',
	'preflight.audioDisconnected': 'Aucune source non coupée n’est connectée au mélangeur.',
	'preflight.audioSilent':
		'Aucun son détecté. Parlez dans le microphone puis relancez la vérification.',
	'preflight.audioMoving': 'Le mélangeur reçoit du son.',
	'preflight.renderingDetail': '{fps} images/s (actuel/cible)',
	'preflight.sourceDetail': 'À vérifier : {names}',
	'preflight.destinationDetail': 'Invalides : {names}',
	...
	'settings.recordingFormat': 'Format local',
	'settings.recordingAudio': 'Audio seul (MP3)',
	'settings.recordingVideo': 'Vidéo avec audio (MP4)',
	'settings.recordingBoth': 'Les deux (MP3 + MP4)',
	'settings.recordingAudioQuality': 'Qualité audio de l’enregistrement',
	'settings.recordingVideoQuality': 'Qualité vidéo de l’enregistrement',
	'settings.recordingCompact': 'Compacte',
	'settings.recordingStandard': 'Standard',
	'settings.recordingHigh': 'Élevée',
	'settings.recordingQualityHint':
		'Une qualité supérieure crée des fichiers plus volumineux. 128 kb/s convient à la parole ; 192–320 kb/s à la musique. Les deux crée deux fichiers de même nom dans le dossier d’enregistrement, prêts à partager après l’arrêt. La vidéo utilise la résolution du canevas. Les modifications s’appliquent au prochain enregistrement.',
	...
	'settings.videoBitrate': 'Débit vidéo de diffusion — {kbps} kb/s',
	'settings.uploadHint': 'Prévoyez au moins {mbps} Mb/s d’envoi réel.',
	'settings.audioBitrate': 'Débit audio de diffusion',
